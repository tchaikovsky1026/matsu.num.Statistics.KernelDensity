...
/**
 * {@link FilterZeroFillingConvolutionForTesting} のテスト.
 */
@RunWith(Enclosed.class)
final class FilterZeroFillingConvolutionForTestingTest {

    public static class フィルタの適用のテスト {

        private FilterZeroFillingConvolutionForTesting filterConvolution;

        @Before
        public void before_片側サイズ4のフィルタを生成する() {
            double[] filter = { 1d, 1d / 2, 1d / 4, 1d / 8 };
            filterConvolution = new FilterZeroFillingConvolutionForTesting(filter);
        }
