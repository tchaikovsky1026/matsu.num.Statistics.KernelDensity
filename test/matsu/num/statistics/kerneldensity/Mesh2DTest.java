...
final class Mesh2DTest {
    ...
    public static class メッシュ計算のテスト {
        ...
        public void test_extendXYのテスト() {
            ...
            assertThat(mesh2d.extendX.length, is(11));
            assertThat(mesh2d.extendX[0], is(-2d));
            assertThat(mesh2d.extendX[1], is(-1.5d));
            assertThat(mesh2d.extendX[2], is(-1d));
            assertThat(mesh2d.extendX[3], is(-0.5d));
            assertThat(mesh2d.extendX[4], is(0d));
            assertThat(mesh2d.extendX[5], is(0.5d));
            assertThat(mesh2d.extendX[6], is(1d));
            assertThat(mesh2d.extendX[7], is(1.5d));
            assertThat(mesh2d.extendX[8], is(2d));
            assertThat(mesh2d.extendX[9], is(2.5d));
            assertThat(mesh2d.extendX[10], is(3d));
        ...
        public void test_weightのテスト() {
             ...
             * [7][7]: 0.5 * 0.25 * 0.5
             */
            double[][] expectedWeight = new double[11][13];
            // [5.0][7.0]
            expectedWeight[5][7] = 0.5 * 1 * 1;
            expectedWeight[6][6] = 0.5 * 0.75 * 0.5;
            expectedWeight[6][7] = 0.5 * 0.75 * 0.5;
            expectedWeight[7][6] = 0.5 * 0.25 * 0.5;
            expectedWeight[7][7] = 0.5 * 0.25 * 0.5;
