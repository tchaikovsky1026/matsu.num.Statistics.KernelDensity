...
import matsu.num.statistics.kerneldensity.FilterZeroFillingConvolutionForTesting;

/**
 * {@link NaiveFilterZeroFillingConvolutionIncubator} のテスト.
 */
@RunWith(Enclosed.class)
final class NaiveFilterZeroFillingConvolutionIncubatorTest {

    private static final NaiveFilterZeroFillingConvolutionIncubator TESTING_CONVOLUTION =
    ...
    public static class フィルタサイズ5での網羅的テスト {
        ...
        public void test_畳み込みの検証(int signalSize) {
            ...
            assertThat(DoubleValueUtilForIncubator.absMax(res), is(lessThan(1E-13)));
        }
    }
